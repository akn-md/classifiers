...
import nayak.Utility.VectorTools;

/**
 * https://code.google.com/p/wordsimilarity/source/browse/trunk/src/tools/Tsne.java
 *
 */
public class Tsnep {
    
    public static double[][] tsne_p(double[][] p, int no_dims) {
            /*
